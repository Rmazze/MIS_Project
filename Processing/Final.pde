...
int happyDur = 2050;    // duration of the happy melody
...
int sadDur = 3250;    // duration of the sad melody
...
void SadRain(float start) {
  ...
  if (init == false) {
    xpos1 = random(-width/2, width/2);    // randomly initialize the position of the drop1 in the x axis
