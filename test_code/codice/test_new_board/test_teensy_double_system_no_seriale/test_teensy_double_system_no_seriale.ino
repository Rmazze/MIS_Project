...
#define hand_sens_sx 7 //11
#define hand_sens_dx 10 //12

// Sensors to see if the hands are in the correct position to begin the test
#define hand_in_position_sx 23 //36
#define hand_in_position_dx 20 //35
// Leds to indicate if the hands are in the correct position to begin the test
#define hand_in_position_sx_led 24 //38
#define hand_in_position_dx_led 25 //37

// Buttons to start and stop the test
#define reset_button 16 //25
...
#define tactile_stimulus_actuator_sx 31 //13
#define tactile_stimulus_actuator_dx 32 //14

// The electromagnet that release the balls
#define magnet_sx 11 //31
#define magnet_dx 12 //32
  ...
  //if (statecom){
    switch(program_execution_state){
      ...
      case(5):  if(first5){
                ...
                /*if (Serial.available() > 0 && stateSerial){ //cosa fa questo stato?
